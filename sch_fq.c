                      ...
                      struct sk_buff **to_free)
{
    ...
    printk("here before setting flowids \n" );
...
static struct sk_buff *fq_dequeue(struct Qdisc *sch)
{
    ...
    if (( (ucounter >= 15) && !(flipflag)) || ( (ucounter_flow_1 >= 2) && !(ucounter_flow_2) && !(flipflag) && (time_elapsed >= 1000000) )|| (!(ucounter_flow_1) && (ucounter_flow_2 >= 2) && !(flipflag) && (time_elapsed >= 1000000)) || ((ucounter) && (ucounter_flow_1) && (ucounter_flow_2) && !(flipflag) && (time_elapsed >= 3000000)))
