...
static struct sk_buff *fq_dequeue(struct Qdisc *sch) {
    ...
    if (((ucounter >= 20) && !(flipflag)) || ((ucounter_flow_1 >= 10) && !(ucounter_flow_2) && !(flipflag) && (
                                                  time_elapsed >= 50000000)) || (
            !(ucounter_flow_1) && (ucounter_flow_2 >= 10) && !(flipflag) && (time_elapsed >= 50000000)) || (
            (ucounter) && (ucounter_flow_1) && (ucounter_flow_2) && !(flipflag) && (time_elapsed >= 50000000))) {
        printk(
